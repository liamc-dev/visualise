...
class Prim {
  ...
  solve(V, adj, src) {
    ...
    [[prim.init.parent]]const parent = Array(V).fill(null);[[/prim.init.parent]]
    [[prim.init.mst]]const inMST = new Set();[[/prim.init.mst]]
...
export const PRIMS_JS_POINTER_HINTS = {
  "prim.loop": [],
  "prim.pick.scan": [],
  "prim.pick.check": [],
  "prim.pick.best": [],
...
export const PRIMS_JS_POINTER_LABELS = {
  u: "u",
  v: "v",
} as const satisfies Record<string, string>;
