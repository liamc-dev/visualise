export const BFS_PY =
` [[bfs.init]]def bfs(graph, source):[[/bfs.init]]
   [[bfs.init]]visited = {source}[[/bfs.init]]
   [[bfs.init]]queue = deque([source])[[/bfs.init]]
   [[bfs.init]]level = {source: 0}[[/bfs.init]]

   [[bfs.dequeue]]while queue:[[/bfs.dequeue]]
     [[bfs.dequeue]]u = queue.popleft()[[/bfs.dequeue]]

     [[bfs.explore]]for v in graph[u]:[[/bfs.explore]]
       [[bfs.explore]]if v not in visited:[[/bfs.explore]]
         ...
         [[bfs.discover]]queue.append(v)[[/bfs.discover]]
