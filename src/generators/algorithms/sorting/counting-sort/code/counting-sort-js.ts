// src/generators/algorithms/sorting/counting-sort/code/counting-sort-js.ts

export const COUNTING_SORT_JS =
...
export const COUNTING_SORT_JS_POINTER_HINTS = {
  "cs.scan": ["i"],
  "cs.count": ["i"],
  "cs.prefix_read": ["i"],
  "cs.prefix": ["i"],
...
export const COUNTING_SORT_JS_POINTER_LABELS = {} as const satisfies Record<string, string>;
