export const SELECTION_SORT_JS =
` [[ss.init]]function selectionSort(a) {[[/ss.init]]
   const n = a.length;
...
export const SELECTION_SORT_JS_POINTER_HINTS = {
...
export const SELECTION_SORT_JS_POINTER_LABELS = {
  i: "i",
  j: "j",
  min: "min",
} as const satisfies Record<string, string>;
