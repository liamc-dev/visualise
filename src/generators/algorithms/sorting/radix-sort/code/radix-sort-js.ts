// src/generators/algorithms/sorting/radix-sort/code/radix-sort-js.ts

export const RADIX_SORT_JS =
...
export const RADIX_SORT_JS_POINTER_HINTS = {
  "rx.extract": ["i"],
  "rx.count": ["i"],
  "rx.place": ["i"],
} as const satisfies Record<string, string[]>;

export const RADIX_SORT_JS_POINTER_LABELS = {} as const satisfies Record<string, string>;
