// src/generators/algorithms/sorting/quick-sort/code/quick-sort.js.ts

export const QUICK_SORT_JS =
` [[qs.init]]function quickSort(a, lo, hi) {[[/qs.init]]
 ...
 [[qs.partition_call]]function partition(a, left, right) {[[/qs.partition_call]]
...
export const QUICK_SORT_JS_POINTER_HINTS = {
...
export const QUICK_SORT_JS_POINTER_LABELS = {
  pivot: "pivot",
} as const satisfies Record<string, string>;
