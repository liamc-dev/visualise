export const LINREG_TS =
` // Linear Regression via Gradient Descent
 // Minimizes MSE: L = (1/n) Σ(yᵢ - ŷᵢ)²

 [[reg.data]]function fit(X: number[], Y: number[], lr: number, epochs: number) {[[/reg.data]]
...
export const LINREG_TS_POINTER_HINTS = {} as const satisfies Record<string, string[]>;

export const LINREG_TS_POINTER_LABELS = {} as const satisfies Record<string, string>;
