export const BINARY_SEARCH_TS =
` [[bin.init]]export function binarySearch(a: number[], target: number): number {[[/bin.init]]
...
export const BINARY_SEARCH_TS_POINTER_HINTS = {
  "bin.loop": ["lo", "hi"],
  "bin.mid": ["lo", "hi", "mid"],
...
export const BINARY_SEARCH_TS_POINTER_LABELS = {
  lo: "lo",
  hi: "hi",
  mid: "mid",
} as const satisfies Record<string, string>;
