export const BINARY_SEARCH_JAVA =
` [[bin.init]]static int binarySearch(int[] a, int target) {[[/bin.init]]
...
export const BINARY_SEARCH_JAVA_POINTER_HINTS = {
  "bin.loop": ["lo", "hi"],
  "bin.mid": ["lo", "hi", "mid"],
...
export const BINARY_SEARCH_JAVA_POINTER_LABELS = {
  lo: "lo",
  hi: "hi",
  mid: "mid",
} as const satisfies Record<string, string>;
